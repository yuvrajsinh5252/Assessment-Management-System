...
const reportConfig = {
  ...
  assessments: {
    as_hr_02: {
      ...
      summary: 'Comprehensive overview of body vitals, posture, and conditioning indicators.',
      sections: [
        {
    ...
    as_card_01: {
      ...
      summary: 'Targeted summary of cardiovascular vitals and body composition.',
      sections: [
        {
          title: 'Overall Snapshot',
          layout: 'grid',
